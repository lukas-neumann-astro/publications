...
\begin{document} 
 ...
 %  \subtitle{I. subtitle}
   ...
   \author{Lukas~Neumann
          ...
          \and
          Adam~K.~Leroy\inst{4}~\orcid{0000-0002-2545-1700}
          \and
          Frank~Bigiel\inst{1}~\orcid{0000-0003-0166-9745}
          \and
          Antonio~Usero\inst{2}~\orcid{0000-0003-1242-505X}
          \and
          Jiayi~Sun\inst{5}~\orcid{0000-0003-0378-4667}
          \and
          Eva~Schinnerer\inst{6}~\orcid{0000-0002-3933-7677}
          \and
          Miguel~Querejeta\inst{2}~\orcid{0000-0002-0472-1011}
          \and
          Sophia~K.~Stuber\inst{6}~\orcid{0000-0002-9333-387X}
          \and
          Ivana~Be\v{s}li\'c\inst{7}~\orcid{0000-0003-0583-7363}
          \and
          Ashley~Barnes\inst{8}~\orcid{0000-0003-0410-4504}
          \and
          ...
          \and
          Ralf~S.~Klessen\inst{12,13,14}~\orcid{0000-0002-0560-3172}
          \and 
          Fu-Heng~Liang\inst{15}~\orcid{0000-0003-2496-1247}
          \and
          Daizhong~Liu\inst{16}~\orcid{0000-0001-9773-7479}
          \and
          Hsi-An~Pan\inst{17}~\orcid{0000-0002-1370-6964}
          \and
          Thomas~G.~Williams\inst{18}~\orcid{0000-0002-0012-2142}
          }
...
% 5 {} token are mandatory
  ...
  % results heading (mandatory)
    ...
    % In contrast, the presence of an active galactic nucleus does not significantly affect these ratios in centres.
  % conclusions heading (optional), leave it empty if necessary 
   % We also demonstrate that ALMOND and EMPIRE yield mutually consistent results so that our measurements represent the most general determination of these dense gas tracer scaling relations across nearby star-forming galaxies to date.
...
% The dash-dotted line in the left panel indicates where we consider that the regime changes to mostly \lir of individual clouds, clumps, or star-forming regions rather than SFR averaged over a large part of a galaxy. 
...
%The regions cover HCN luminosities between $\lhcn=\SI{e4}{\kkms\square\parsec}$ and \SI{e8}{\kkms\square\parsec} and SFRs between $\mathrm{sfr}=\SI{e-3}{\msun\per\year}$ and \SI{1}{\msun\per\year}. 
...
% We note that the axes in the HCN/CO against \sigmol and \pde relations are correlated, since \sigmol and \pde depend on CO, while \sigstar is independent on CO or HCN, hence giving additional weight on the HCN/CO against \sigstar relation.
...
% Centres and discs show distinct distributions in the HCN/CO scaling relations, where centres have a factor of 9 higher \sigstar and a factor of 3.5 higher HCN/CO.
% In the SFR/HCN relations, centres and discs have more comparable, overlapping SFR/HCN distributions with median values offset by a factor of 1.5, but overlapping distribution within 1-sigma.
% However, centres with particularly high \sigstar ($>\SI{e3}{\msun\per\square\parsec}$) show a factor of 2 lower SFR/HCN than discs.
% Such lower SFR/HCN is also observed for the CMZ of the Milky Way \citep{Henshaw2023}.
...
\begin{table*}
    ...
    \hline \hline
    \multirow{3}{*}{Regime} & $\log_{10}\,$SFR/HCN & $\log_{10}\,$IR/HCN & $\log_{10}\,\taudense$ & $\log_{10}\,\effdense$ & $\sigma$ \\
     & [$\SI{}{\msun\per\year}/(\SI{}{\kkms\square\parsec})$] & [$\SI{}{\lsun}/(\SI{}{\kkms\square\parsec})$] & [$\SI{}{\year}$] &  & $[\SI{}{\dex}]$ \\
     & (16$^\mathrm{th}$, 50$^\mathrm{th}$, 84$^\mathrm{th}$) perc. & (16$^\mathrm{th}$, 50$^\mathrm{th}$, 84$^\mathrm{th}$) perc. & (16$^\mathrm{th}$, 50$^\mathrm{th}$, 84$^\mathrm{th}$) perc. & (16$^\mathrm{th}$, 50$^\mathrm{th}$, 84$^\mathrm{th}$) perc. &  \\
     \hline
    Clouds \& Clumps  & $(-7.43,-6.89,-6.27)$ & $(2.40,2.94,3.56)$ & $(7.45,8.07,8.61)$ & $(-2.70,-2.16,-1.54)$ & $0.70$ \\
    ...
    ALMOND \& EMPIRE  & $(-7.14,-6.84,-6.44)$ & $(2.69,2.99,3.39)$ & $(7.62,8.02,8.31)$ & $(-2.41,-2.11,-1.72)$ & $0.35$ \\
    \hline\hline
    \end{tabular}
    }
    \end{center}
    ...
    % with those ratios in units of $\SI{}{\msun\per\year}/(\SI{}{\kkms\square\parsec})$ and $\SI{}{\lsun}/(\SI{}{\kkms\square\parsec})$, respectively.
...
% $^\dagger$ Intercepts are given with respect to an $x$-axis offset of 2.4, 1.4, and 5.0 in logarithmic scale and aforementioned units for \sigstar, \sigmol and \pde, respectively.
\end{table*}
%-------------------------------------------------------------------
